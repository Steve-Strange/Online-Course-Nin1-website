"""
Django settings for CourseRecom project.
...
SECRET_KEY = 'django-insecure-(icab)+05m@s(a#vwiykncp%q+))ide*lhslb3*i#e9hega7g1'
...
WSGI_APPLICATION = 'CourseRecom.wsgi.application'
...
GRAPH_JSON_DIR = os.path.join(BASE_DIR, 'static/graphs')
